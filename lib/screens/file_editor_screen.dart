...
class _FileEditorScreenState extends State<FileEditorScreen> {
  ...
  Future<void> _save() async {
    ...
    if (mounted) setState(() { _saved = true; _modified = false; });
    ...
    final result = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async { await _save(); Navigator.pop(context, true); },
        ...
        appBar: AppBar(
          ...
          title: Row(children: [
            Text(widget.file.name,
                style: const TextStyle(fontFamily: 'monospace', fontSize: 14, color: AppTheme.textPrimary)),
            const SizedBox(width: 8),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
              decoration: BoxDecoration(color: AppTheme.accent.withOpacity(0.2),
                  borderRadius: BorderRadius.circular(4)),
              child: Text('v${widget.file.version}',
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Text('${_ctrl.text.length} chars',
                    style: const TextStyle(color: AppTheme.textMuted, fontSize: 11, fontFamily: 'monospace')),
                const Spacer(),
                Text(widget.file.ext.toUpperCase(),

      ...
      onPopInvoked: (didPop) async {
        ...
        final result = await showDialog<bool>(
          ...
          builder: (_) => AlertDialog(
            ...
            content: const Text('পরিবর্তন সেভ না করে বেরিয়ে গেলে হারিয়ে যাবে।', style: TextStyle(color: AppTheme.textSecondary)),
            actions: [
        ...
        appBar: AppBar(
            ...
            IconButton(
              onPressed: () async {
                ...
                if (mounted) ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('কপি হয়েছে!'), backgroundColor: AppTheme.green, duration: Duration(seconds: 2)));
              },
          ...
          bottom: PreferredSize(
            ...
            child: Container(
              ...
              child: Row(children: [
                Text('$_lineCount লাইন', style: const TextStyle(color: AppTheme.textMuted, fontSize: 11, fontFamily: 'monospace')),
